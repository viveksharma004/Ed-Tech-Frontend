...
const About = () => {
  ...
  return (
    <div>
      ...
      <section>
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-8 text-richblack-500">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-7">
            ...
            <div>
              <img
                src={FoundingStory}
                alt=""
                className="shadow-[6px_4px_10px_0] shadow-[#FC6767]"
              />
            </div>
          </div>
      ...
      {/* section 4 */}
      <StatsComponent/>
      <section className="mx-auto mt-20  mb-10 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
